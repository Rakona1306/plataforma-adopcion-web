...
{
    public class CreatePubRequestAdoptionValidator : AbstractValidator<CreatePubRequestAdoption>
    {
        public CreatePubRequestAdoptionValidator()
        {
            RuleFor(x => x.PetId)
                .NotEmpty()
            ...
            RuleFor(x => x.Address)
                .NotEmpty()
                    .WithMessage("La ubicacion de su residencia es obligatoria");
