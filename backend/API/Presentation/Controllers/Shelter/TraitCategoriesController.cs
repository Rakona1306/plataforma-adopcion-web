...
using API.Application.Services.Shelter.TraitCategories;
...
namespace API.Presentation.Controllers.Shelter
{
    ...
    public class TraitCategoriesController : ControllerBase
    {
        private readonly ITraitCategoryService
        _service;

        public TraitCategoriesController(
            ITraitCategoryService service
        )
        {
            _service = service;
        }
