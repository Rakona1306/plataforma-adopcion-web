...
import {
  UpdateVaccineForm,
  ViewVaccine,
} from "@/features/shelter/vaccine/components";
import useActionsVaccine from "@/features/shelter/vaccine/hooks/use-actions-vaccine";

export default function VaccinePageNext() {
