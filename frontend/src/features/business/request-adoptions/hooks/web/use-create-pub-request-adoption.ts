...
export default function useCreatePubRequestAdoption(
  props?: UseMutationOptions<void, unknown, CreatePubReqAdoption>,
) {
  ...
  const {
    ...
    ...props,
    mutationFn: (dto: CreatePubReqAdoption) =>
      pubRequestAdoptionService.create(dto),
    onError: (error: any) => {
