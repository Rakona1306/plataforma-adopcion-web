...
export default function useUpdateRequestAdoption(props?: UseMutationOptions<void, unknown, UpdateRequestAdoptionDto>) {
    ...
    const mutation = useMutation({
        ...props,
        mutationFn: (dto: UpdateRequestAdoptionDto) => requestAdoptionService.update(dto.id, dto),
        onError: (error: any) => {
