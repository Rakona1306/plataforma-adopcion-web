...
class RequestAdoptionService implements IRequestAdoptionService {
    ...
    async create(createReq: CreateRequestAdoptionDto): Promise<void> {
        return this.httpClient.post<void>(API_ENDPOINTS.REQUEST_ADOPTION.CREATE, createReq);
    }

    async update(requestId: number, dto: UpdateRequestAdoptionDto): Promise<void> {
        return this.httpClient.put(API_ENDPOINTS.REQUEST_ADOPTION.UPDATE(requestId), dto);
    }
    ...
    async delete(requestId: number): Promise<void> {
        return this.httpClient.delete(API_ENDPOINTS.REQUEST_ADOPTION.DELETE(requestId));
    }


    async reviewAdoptionRequest(requestId: number, dto: ReviewReqAdoptionDto): Promise<void> {
        return this.httpClient.put<void>(API_ENDPOINTS.REQUEST_ADOPTION.REVIEW(requestId), dto);
    }
}
