        ...
        <div className='w-full'>
                    ...
                    <Card withBorder p="md" radius="md" bg="gray.0">
                        <Group>
                            ...
                            <div>
                                ...
                                <Text fw={600}>{request.user.name} {request.user.lastName}</Text>
                            </div>
                        </Group>
                    </Card>
            ...
            <Paper p="md" radius="md" mb="lg" withBorder>
                <Stack gap="md">
                    ...
                    <Card withBorder p="md" radius="md" bg="gray.0">
                        <Stack gap={'xs'}>
                            <Text size='xs' c="dimmed" fw={500}>Razas</Text>
                            <Flex gap={'xs'} wrap={'wrap'}>
                                {
                                    request.pet.breeds.map((breed) => (
                                        <Pill className='text-xs! w-fit! bg-primary! text-white!' key={`${breed.id}:${breed.name}`}>
                                            {breed.name}
                                        </Pill>
                                    ))
                                }
            ...
            <Paper p="md" radius="md" mb="lg" withBorder bg="gray.0">
                <Stack gap="md">
                    ...
                    <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
                        ...
                        <Card withBorder p="md" radius="md" display={'flex'} className='justify-center'>
                            <Group mb="xs">
