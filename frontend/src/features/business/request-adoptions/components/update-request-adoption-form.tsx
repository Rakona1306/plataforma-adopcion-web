...
import { UpdateRequestAdoptionDto, UpdateRequestAdoptionSchema } from "../dto/dashboard/update-request-adoption"
...
export default function UpdateRequestAdoptionForm({ requestAdoption }: Props) {
    ...
    const { update, errorMessage, errorValidation, isPending } = useUpdateRequestAdoption()
                    ...
                    <Grid>
                        ...
                        <Grid.Col span={{ base: 12, sm: 6 }}>
                            <Input
                                ...
                                required
                                defaultValue={requestAdoption.dni || requestAdoption.user.dni || ''}
                    ...
                    <Grid>
                        <Grid.Col span={{ base: 12, sm: 6 }}>
                            <Input
                                ...
                                label="Telefono"
                                required
                                defaultValue={requestAdoption.phone || requestAdoption.user.phone || ''}
                        ...
                        <Grid.Col span={{ base: 12, sm: 6 }}>
                            <SelectInput
                                ...
                                defaultValue={requestAdoption.district || requestAdoption.user.district || ''}
                                required
