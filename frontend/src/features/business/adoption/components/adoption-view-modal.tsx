...
export default function AdoptionViewModal({ adoption }: Props) {
    ...
    const getStatusColor = (status: string) =>
        statusColor[status?.toUpperCase()] ?? 'gray'
                        ...
                        <Card withBorder p="md" radius="md" bg="gray.0">
                            <Flex direction="column" gap="xs">
                                ...
                                <div>
                                    ...
                                    <Text fw={600}>{requestAdoption.houseType || 'No especificado'}</Text>
                                </div>
                            </Flex>
                        </Card>
                    </SimpleGrid>
                ...
                <Stack gap="md">
                    ...
                    <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
                        <Card withBorder p="md" radius="md" bg="gray.0">
                            ...
                            <Badge color={requestAdoption.hasOtherPets ? 'green' : 'red'} variant="light">
                        ...
                        <Card withBorder p="md" radius="md" bg="gray.0">
                            ...
                            <Badge color={requestAdoption.hasChildren ? 'green' : 'red'} variant="light">
                        ...
                        <Card withBorder p="md" radius="md" bg="gray.0">
                            ...
                            <Badge color={requestAdoption.acceptHomeVisit ? 'green' : 'red'} variant="light">
                            ...
                            <Card withBorder p="md" radius="md">
                                <Group mb="xs">
                                    ...
                                    <div>
                                        ...
                                        <Text fw={600} size="sm">
                                            {requestAdoption.reviewer.name} {requestAdoption.reviewer.lastName}
                                        </Text>
                                    </div>
                                </Group>
                            </Card>
