...
export default function AccountAdoptionRequestCard({
    ...
    return (
        <Grid.Col span={{ base: 12, sm: 6, md: 4, lg: 3 }} h={'100%'} className="flex! justify-start!">
            <Card withBorder shadow="sm" radius="md" h="100%" w={'100%'} classNames={{
                        ...
                        <Badge
                            color={
                                request.status === "APROBADO"
                                    ? "green"
                                    : request.status === "RECHAZADO" || request.status === "CANCELADO"
                                        ? "red"
                                        : "yellow"
                            }
                        >
