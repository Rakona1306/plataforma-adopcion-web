  ...
  items: [
    {
      ...
      description:
        "Cada adopción es un acto de amor. Nuestras mascotas necesitan un hogar donde puedan ser felices. Haz una diferencia hoy y cambia una vida.",
      cta: "Ver Mascotas",
      ctaLink: "/mascotas",
      category: "adopcion",
    },
    {
      ...
      description:
        "Con tu aporte mensual, proporcionas alimento, cuidados médicos y amor. Recibe fotos y actualizaciones mensuales de tu mascota.",
    ...
    },
    {
      ...
      description:
        "Necesitamos manos amigas para cuidar, pasear y socializar a nuestras mascotas. Si amas a los animales, ¡te necesitamos!",
      cta: "Sé Voluntario",
    ...
    },
    {
      ...
      description:
        "Nuestro equipo de expertos está disponible 24/7 para asesorarte sobre cuidados, salud y comportamiento de tu nueva familia.",
      cta: "Nosotros",
      ctaLink: "/nosotros",
    ...
    },
    {
      ...
      description:
        "Cientos de familias han encontrado la felicidad adoptando con nosotros. Lee sus historias y déjate inspirar para dar el siguiente paso.",
